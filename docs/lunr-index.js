...
documentTitles["readme.html#php-debug-bar"] = "PHP Debug Bar";
index.add({
    url: "readme.html#php-debug-bar",
    title: "PHP Debug Bar",
...
documentTitles["data-collectors.html#collecting-data"] = "Collecting Data";
index.add({
    url: "data-collectors.html#collecting-data",
    title: "Collecting Data",
    body: "# Collecting Data  "
});

documentTitles["data-collectors.html#using-collectors"] = "Using collectors";
index.add({
    url: "data-collectors.html#using-collectors",
...
documentTitles["data-collectors.html#creating-collectors"] = "Creating collectors";
index.add({
    url: "data-collectors.html#creating-collectors",
...
documentTitles["rendering.html#rendering"] = "Rendering";
index.add({
    url: "rendering.html#rendering",
    title: "Rendering",
...
documentTitles["rendering.html#assets"] = "Assets";
index.add({
    url: "rendering.html#assets",
    title: "Assets",
...
documentTitles["rendering.html#managing-jquery-conflicts"] = "Managing jQuery conflicts";
index.add({
    url: "rendering.html#managing-jquery-conflicts",
...
documentTitles["rendering.html#the-javascript-object"] = "The javascript object";
index.add({
    url: "rendering.html#the-javascript-object",
...
documentTitles["rendering.html#controlling-object-initialization"] = "Controlling object initialization";
index.add({
    url: "rendering.html#controlling-object-initialization",
...
documentTitles["rendering.html#defining-controls"] = "Defining controls";
index.add({
    url: "rendering.html#defining-controls",
...
documentTitles["base-collectors.html#timedata"] = "TimeData";
index.add({
    url: "base-collectors.html#timedata",
    title: "TimeData",
...
documentTitles["base-collectors.html#exceptions"] = "Exceptions";
index.add({
    url: "base-collectors.html#exceptions",
    title: "Exceptions",
...
documentTitles["base-collectors.html#pdo"] = "PDO";
index.add({
    url: "base-collectors.html#pdo",
    title: "PDO",
...
documentTitles["base-collectors.html#requestdata"] = "RequestData";
index.add({
    url: "base-collectors.html#requestdata",
    title: "RequestData",
...
documentTitles["base-collectors.html#config"] = "Config";
index.add({
    url: "base-collectors.html#config",
    title: "Config",
...
documentTitles["base-collectors.html#aggregatedcollector"] = "AggregatedCollector";
index.add({
    url: "base-collectors.html#aggregatedcollector",
...
documentTitles["base-collectors.html#others"] = "Others";
index.add({
    url: "base-collectors.html#others",
    title: "Others",
...
documentTitles["bridge-collectors.html#bridge-collectors"] = "Bridge collectors";
index.add({
    url: "bridge-collectors.html#bridge-collectors",
...
documentTitles["bridge-collectors.html#cachecache"] = "CacheCache";
index.add({
    url: "bridge-collectors.html#cachecache",
    title: "CacheCache",
...
documentTitles["bridge-collectors.html#doctrine"] = "Doctrine";
index.add({
    url: "bridge-collectors.html#doctrine",
    title: "Doctrine",
...
documentTitles["bridge-collectors.html#monolog"] = "Monolog";
index.add({
    url: "bridge-collectors.html#monolog",
    title: "Monolog",
...
documentTitles["bridge-collectors.html#propel"] = "Propel";
index.add({
    url: "bridge-collectors.html#propel",
    title: "Propel",
...
documentTitles["bridge-collectors.html#slim"] = "Slim";
index.add({
    url: "bridge-collectors.html#slim",
    title: "Slim",
...
documentTitles["bridge-collectors.html#swift-mailer"] = "Swift Mailer";
index.add({
    url: "bridge-collectors.html#swift-mailer",
    title: "Swift Mailer",
...
documentTitles["bridge-collectors.html#twig"] = "Twig";
index.add({
    url: "bridge-collectors.html#twig",
    title: "Twig",
...
documentTitles["storage.html#available-storage"] = "Available storage";
index.add({
    url: "storage.html#available-storage",
...
documentTitles["storage.html#creating-your-own-storage"] = "Creating your own storage";
index.add({
    url: "storage.html#creating-your-own-storage",
...
documentTitles["storage.html#request-id-generator"] = "Request ID generator";
index.add({
    url: "storage.html#request-id-generator",
...
documentTitles["openhandler.html#open-handler"] = "Open handler";
index.add({
    url: "openhandler.html#open-handler",
    title: "Open handler",
...
documentTitles["http-drivers.html#http-drivers"] = "HTTP drivers";
index.add({
    url: "http-drivers.html#http-drivers",
    title: "HTTP drivers",
    body: "# HTTP drivers  Some features of the debug bar requires sending http headers or using the session. Many frameworks implement their own mechanism on top of PHP native features.  Two make integration with other frameworks as easy as possible, the `DebugBar` object uses an instance of `DebugBar\HttpDriverInterface` to access those features.  `DebugBar\PhpHttpDriver`, which uses native PHP mechanisms, is provided  and will be used if no other driver are specified."
});



documentTitles["javascript-bar.html#javascript-bar"] = "Javascript Bar";
index.add({
    url: "javascript-bar.html#javascript-bar",
...
documentTitles["javascript-bar.html#tabs-and-indicators"] = "Tabs and indicators";
index.add({
    url: "javascript-bar.html#tabs-and-indicators",
...
documentTitles["javascript-bar.html#data-mapping"] = "Data mapping";
index.add({
    url: "javascript-bar.html#data-mapping",
    title: "Data mapping",
...
documentTitles["javascript-bar.html#datasets"] = "Datasets";
index.add({
    url: "javascript-bar.html#datasets",
    title: "Datasets",
...
documentTitles["javascript-bar.html#widgets"] = "Widgets";
index.add({
    url: "javascript-bar.html#widgets",
    title: "Widgets",
...
documentTitles["javascript-bar.html#custom-tabs-and-indicators"] = "Custom tabs and indicators";
index.add({
    url: "javascript-bar.html#custom-tabs-and-indicators",
...
documentTitles["javascript-bar.html#openhandler"] = "OpenHandler";
index.add({
    url: "javascript-bar.html#openhandler",
    title: "OpenHandler",
